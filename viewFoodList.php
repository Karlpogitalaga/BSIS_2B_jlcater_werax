...
<body background= "img/burger-fries-rings-coke.jpg">
    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3 m-3">
                        <div class="card" style="width: 19rem;">
                            <img src="img/image-'.$foodId. '.jpg" class="card-img-top" alt="image for this food" width="249px" height="270px">
                            <div class="card-body">
                                <h5 class="card-title">' . substr($foodName, 0, 20). '...</h5>
                                <h6 style="color: #ff0000">Php '.$foodPrice. '.00</h6>
